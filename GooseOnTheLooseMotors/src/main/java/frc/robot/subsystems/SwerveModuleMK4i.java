...
public class SwerveModuleMK4i {
  ...
  public SwerveModuleMK4i(TalonFX driveMotor, TalonFX angleMotor, CANCoder canCoder, Rotation2d offset) {
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    // below is a line to comment out from step 5
    driveMotor.set(TalonFXControlMode.PercentOutput, feetPerSecond / SwerveDriveSubsystem.kMaxSpeed);
  }
}